    ...
    >
      <Card className="p-6 bg-white/80 backdrop-blur-lg">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="automaticThoughts" className="block text-sm font-medium text-gray-700">Automatic Thoughts</label>
            <Textarea
          ...
          <div className="space-y-2">
            <label htmlFor="emotions" className="block text-sm font-medium text-gray-700">Emotions</label>
            <Input
              id="emotions"
          ...
          <div className="space-y-2">
            <label htmlFor="distortion" className="block text-sm font-medium text-gray-700">Cognitive Distortion</label>
          ...
          <div className="space-y-2">
            <label htmlFor="evidenceFor" className="block text-sm font-medium text-gray-700">Evidence For</label>
            <Textarea
              id="evidenceFor"
          ...
          <div className="space-y-2">
            <label htmlFor="evidenceAgainst" className="block text-sm font-medium text-gray-700">Evidence Against</label>
            <Textarea
              id="evidenceAgainst"
          ...
          <div className="space-y-2">
            <label htmlFor="alternativeThought" className="block text-sm font-medium text-gray-700">Alternative Thought</label>
            <Textarea
          ...
          <div className="space-y-2">
            <label htmlFor="newEmotion" className="block text-sm font-medium text-gray-700">New Emotion</label>
            <Input
              id="newEmotion"
