---
title: "Fight, Flight, Freeze, Fawn : tes 4 réactions de survie face au danger"
description: "Comprendre tes 4 réactions instinctives face au stress et à la violence : combat, fuite, sidération et appaisement. Ces mécanismes de survie ancestraux peuvent s'ancrer durablement et façonner ta vie bien au-delà de la menace initiale."
---
...
:::note[La fenêtre de tolérance]
Chaque personne a une "fenêtre de tolérance" — une zone dans laquelle le système nerveux peut fonctionner de façon flexible. La sidération se déclenche quand on sort brusquement de cette fenêtre par le bas. Les traumatismes répétés rétrécissent cette fenêtre, rendant le freeze plus facilement accessible.
:::
...
:::tip[Reconnaitre le fawn en soi]
Pose-toi ces questions : Est-ce que tu t'accordes facilement avec les autres pour éviter le conflit, même quand tu n'es pas d'accord ? Est-ce que tu ressens une anxiété forte quand quelqu'un est mécontent de toi, même sans raison valable ? Est-ce que tes besoins passent systématiquement après ceux des autres ? Si oui, tu connais probablement le fawn.
:::
...
Grandir dans un environnement traumatisant — violence, négligence, imprévisibilité — rigidifie ces réponses. Ton système nerveux apprend à sur-utiliser certaines réponses (toujours en mode fight, toujours à fuir, toujours à vous soumettre) et à sous-utiliser d'autres. À l'âge adulte, ces patterns peuvent sembler disproportionnés ou inadaptés — non pas parce qu'ils sont faux, mais parce qu'ils ont été calibrés sur d'anciens dangers qui n'existent plus.
