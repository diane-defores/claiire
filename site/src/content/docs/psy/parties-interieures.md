---
title: "Les parties intérieures | Découvrir notre famille intérieure"
description: "Explorez la richesse de ton monde intérieur et apprends à dialoguer avec tes différentes parties pour plus d'harmonie et de compréhension de soi"
---
...
Institut Francophone pour le Développement du Self Leadership, ou [IFS-association,](https://ifs-association.com/ifs-association-internal-family-systems-monde-francophone/) est une association qui a pour but de promouvoir le développement du Self Leadership et de la guérison intérieure.

## Le théâtre intérieur : une métaphore vivante

Imagine ton monde intérieur comme une scène de théâtre où différents personnages interagissent continuellement. Sarah, une de nos patientes, le décrit ainsi : "C'est comme si j'avais une critique intérieure qui me pousse toujours à faire mieux, une partie anxieuse qui anticipe le pire, et une partie blessée qui porte encore la douleur de mon enfance."
...
:::tip[Exercice de base]
Pour commencer à explorer tes parties :
1. Trouve un moment calme et un endroit confortable
2. Porte ton attention sur une réaction ou une émotion récurrente
3. Demande-toi : "Quelle partie de moi réagit ainsi ?"
4. Observe avec curiosité ce qui émerge
5. Accueille cette partie avec bienveillance, sans chercher à la changer
:::
...
- Les liens avec la [résilience](/psy/solution/resilience)
- L'impact sur l'[équilibre mental](/psy/equilibre/equilibre-mental)
- Le rôle du [système nerveux](/systeme-nerveux/structure)
:::

:::danger[Accompagnement]
L'exploration des parties, particulièrement celles qui portent des traumatismes, peut faire remonter des émotions intenses. Un accompagnement professionnel est recommandé pour ce travail en profondeur.
:::
...
*Notre monde intérieur est un écosystème complexe et fascinant. [Explorez nos autres ressources](/psy) pour approfondir ta compréhension de toi-même et développer une relation plus harmonieuse avec tes parties.*